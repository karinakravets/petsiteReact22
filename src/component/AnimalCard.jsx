        ...
        <div className="card h-100" style={{"minWidth":"320px"}}>
            ...
            <div className="card-body ft">
                <div>
                    ...
                    <div><button onClick={() => {navigate("/InfCard", { state: props.data.id })}} className="btn btn-primary ff m-auto" style={{border:"none", backgroundColor: 'rgb(218, 191, 141)'}} >Подробнее</button></div>
            </div>
        </div>
    </div>
    );
