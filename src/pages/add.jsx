...
const Add = ()=>{
    ...
    return(
        <div>
            <Header/>
            <h2 className="text-center text-white bg-primary m-2 " style={{backgroundColor: 'rgb(218, 191, 141)'}} >Добавить объявления</h2>
            <form className="contei w-50 m-auto p-5" id="dobav"  noValidate onSubmit={dobav} >
                ...
                <details className="w-100 d-flex flex-column justify-content-center align-items-center">
                    <summary className="btn btn-primary w-50 d-flex flex-column justify-content-center align-items-center" style={{backgroundColor: 'rgb(218, 191, 141)', "margin": "auto", "marginbBottom": "20px" }}>
                        Зарегистрироваться
                    </summary>
                ...
                <div className="d-flex justify-content-center align-items-center">
                    <button type="submit" className="btn btn-primary" style={{backgroundColor: 'rgb(218, 191, 141)'}}>Выложить объявление</button>
                </div>
            </form>
